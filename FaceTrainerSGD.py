...
# Note: this works for 16GB ram but may not work for less, for 8GB ram 3000 images is recommended
...
hogify = HogTransformer(pixels_per_cell=(6, 6), cells_per_block=(2, 2),orientations=9,block_norm='L2-Hys')
# for scaling image
...
joblib.dump(grayify,'jobgrayifier.pkl')
joblib.dump(hogify,'jobhogifier.pkl')
