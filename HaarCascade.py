...
# then it also predicts whether the face is male or female.
    def __init__(self,filename):
        ...
        data['filename'] = []
        data['data'] = []
        shutil.rmtree('C:/Users/Josh/PycharmProjects/CPSC371Project/NewJpg')
        os.mkdir('C:/Users/Josh/PycharmProjects/CPSC371Project/NewJpg')
        isRect = False
        for i in range(len(roi_colorList)):
            # we write a jpg for each of the rectangle images.
            isRect = True
            cv2.imwrite('C:/Users/Josh/PycharmProjects/CPSC371Project/NewJpg/rulersmall'+str(i)+'.jpg',roi_colorList[i])
        # load classifier
        clf = joblib.load(f'faceclassifier.joblib')
        current_path = os.path.join(os.getcwd(),'C:/Users/Josh/PycharmProjects/CPSC371Project/NewJpg')
        i = 0
        ...
        if isRect:
            ...
            cv2.imwrite('C:/Users/Josh/PycharmProjects/CPSC371Project/NewJpg/finalpic.jpg',img)
            self.finalImage = 'C:/Users/Josh/PycharmProjects/CPSC371Project/NewJpg/finalpic.jpg'
